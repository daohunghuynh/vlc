...
//#pragma mark - Initialization
    ...
    private func setupMenuItem(_ menuItem: NSMenuItem, withConfigKey configKey: String) {
        ...
        let stringUtility: VLCStringUtility = VLCStringUtility.instance

        key = config_GetPsz(configKey)
        keyString = String(cString: key)
        menuItem.keyEquivalent = stringUtility.VLCKeyToString(keyString)
        menuItem.keyEquivalentModifierMask = NSEvent.ModifierFlags(rawValue: stringUtility.VLCModifiersToCocoa(keyString))
        free(key)
    }
...
//#pragma mark - Interface update
    ...
    private func setSubmenusEnabled(_ b_enabled: Bool) {

        self.program.isEnabled = b_enabled
        self.titleMenuItem.isEnabled = b_enabled
        self.chapter.isEnabled = b_enabled
        self.audiotrack.isEnabled = b_enabled
        self.visual.isEnabled = b_enabled
        self.videotrack.isEnabled = b_enabled
        self.subtitle_track.isEnabled = b_enabled
        self.channels.isEnabled = b_enabled
        self.deinterlace.isEnabled = b_enabled
        self.deinterlace_mode.isEnabled = b_enabled
        self.screen.isEnabled = b_enabled
        self.aspect_ratio.isEnabled = b_enabled
        self.crop.isEnabled = b_enabled
    }

    private func setSubtitleMenuEnabled(_ b_enabled: Bool) {

        self.openSubtitleFile.isEnabled = b_enabled
        if b_enabled {
        ...
        self.subtitle_bgopacity_sld.isEnabled = b_enabled
        self.teletext.isEnabled = b_enabled
    }

    private func setRateControlsEnabled(_ b_enabled: Bool) {
...
//        VLCCoreInteraction.instance.toggleRecord
    ...
    private func updateRecordState(b_value: Bool) {
