...
//    Bool b_nativeFullscreenMode
    ...
    private var b_alt_pressed: Bool = false
//    Bool b_mouse_over
...
//    }
    ...
    func informModifierPressed(isOptionKey: Bool) {
        let b_state_changed = self.b_alt_pressed != isOptionKey
        self.b_alt_pressed = isOptionKey
        if (b_state_changed) {
...
//func extendedAccessibilityAttributeNames: (NSArray*)theAttributeNames -> (NSArray*)
//func extendedAccessibilityAttributeValue: (NSString*)theAttributeName -> (id)
//func extendedAccessibilityIsAttributeSettable: (NSString*)theAttributeName -> (NSNumber*)
//
//+ (Class)cellClass {
...
//}
//
//func accessibilityPerformAction: (NSString*)theActionName { -> (void)
...
//NSMenu *_contextMenu
//
//func showRightClickMenuWithEvent:(NSEvent *)o_event -> (void)
//{
...
//}
//
//func rightMouseDown:(NSEvent *)o_event -> (void)
//{
